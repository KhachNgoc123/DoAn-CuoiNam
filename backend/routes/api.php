...
| Public auth routes
|--------------------------------------------------------------------------
| Các route này không cần token. Frontend gọi từ trang /login.
*/
...
|--------------------------------------------------------------------------
| Tất cả route bên dưới cần Sanctum token từ frontend/src/api/client.js.
*/
Route::middleware(['auth:sanctum'])->group(function () {
    // Tài khoản bác sĩ và đăng xuất.
    ...
    // Lịch uống thuốc, nhắc thuốc và phản ứng sau uống.
    ...
    // Lookup cho form lịch uống thuốc.
    ...
    // Báo cáo, backup và phản hồi bệnh nhân.
